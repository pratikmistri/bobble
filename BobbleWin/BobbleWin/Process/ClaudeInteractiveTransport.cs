...
// Windows fallback transport for Claude; keeps session continuity and text-reply interruptions.
public sealed class ClaudeInteractiveTransport : IConversationTransport
{
    private readonly CLIConversationTransport _inner = new();
    private string? _sessionId;

    public ClaudeInteractiveTransport(string executablePath, string workingDirectory, ConversationExecutionMode executionMode)
    {
